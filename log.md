...
- Added Action→Template Map for CLI action dispatch.
- Added Log Routing rules and dry-run operation type.
- Updated all templates and backfilled existing topic pages.
- Converted index.md to pipe-delimited format for stable CLI parsing.
